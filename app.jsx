...
function mdToHtml(text) {
    ...
    const flushTable = () => {
      ...
      // Демография — исключение: владелица 14.09 просила оставить её блоком
      ...
      if (!естьДанные && /BLOCK\s*09B\b|Демограф/i.test(lastHeading)) {
        html += '<p class="note">Пол, возраст и достаток нашими средствами не '
          + 'добываются: поисковая частотность отвечает на «что ищут» и «откуда», '
          + 'но не на «кто ищет». Эти строки заполнятся, когда будет доступ к '
          + 'рекламному кабинету (Google Ads, VK) или к Метрике заказчика — '
          + 'там демография считается по живой аудитории, а не оценивается.</p>';
