  ...
  function renderOfferInputBlock(headers, rows) {
    ...
    const подпись = нет.length
      ? '<p class="note">Заполнено ' + (D.length - нет.length) + ' полей из ' + D.length
        ...
        + '<p class="note">Что делать: откройте вкладку <b>«Бриф»</b> → <b>«Править бриф»</b>, '
        + 'заполните эти поля и нажмите <b>↺</b> на этом модуле — офферы пересоберутся '
        + 'уже с ними. Пока поля пусты, модель не имеет права их придумать: выдуманная '
