...
async function gatherVoCEvidence(brief, discoveredCompetitors, m2Result) {
  ...
  // владелицы 15.09).
  const смежные = [
    'мало заявок с сайта при хорошем трафике',
    'посетители уходят с сайта ничего не купив',
    'брошенная корзина интернет-магазин что делать',
    '低 конверсия сайта форум обсуждение',
    'как вернуть ушедшего посетителя сайта',
    'реклама есть заявок нет форум',
  ].map(q => q.replace('低 ', 'низкая '));
