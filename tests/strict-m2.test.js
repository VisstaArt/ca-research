...
ok('матрица приоритизации собрана', /renderNicheMatrix\(/.test(скрипты), true);
ok('решётка сигналов собрана', /renderNicheSignals\(/.test(скрипты), true);
ok('заголовок матрицы на месте', /Матрица приоритизации ниш/.test(р.html), true);
