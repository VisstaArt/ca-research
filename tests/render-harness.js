...
['поТексту','внеСсылок','поЧеловечески','поРусскиСтроку','поРусски','сноскиНаИсточники','оживитьКусок','оживитьСсылки','подсказкиТерминов','оформитьТекст','почиститьХвост','почиститьУзлы','собратьВыводы','найтиБлокАббревиатур','собратьСловарь']
