...
['поТексту','внеСсылок','поЧеловечески','именаБлоковВТексте','поРусскиСтроку','поРусски','сноскиНаИсточники','оживитьКусок','оживитьСсылки','подсказкиТерминов','подсказкиВКуске','строкаРасшифровки','всеРасшифровки','сБольшой','plural','оформитьТекст','почиститьХвост','убратьПустыеПодписи','почиститьУзлы','ссылкиВУзлах','собратьВыводы','собратьШаги','найтиБлокАббревиатур','собратьСловарь','легендаУверенности','выделитьЧисла']
