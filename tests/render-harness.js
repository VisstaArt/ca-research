...
['поТексту','внеСсылок','поЧеловечески','поРусскиСтроку','поРусски','сноскиНаИсточники','оживитьКусок','оживитьСсылки','подсказкиТерминов','оформитьТекст','почиститьХвост','почиститьУзлы','ссылкиВУзлах','собратьВыводы','найтиБлокАббревиатур','собратьСловарь','легендаУверенности','выделитьЧисла']
