...
// 5. В листе не должно быть литеральных «\n» — это следы вставки текстом.
// Такая строка склеивает десяток правил в одно, и ни одно из них не работает
// (16.09: стили географии не применились вовсе, а следующее правило утекло
// из области .rview).
var сырых=(css.match(/\\n/g)||[]).length;
check('в листе нет литеральных переводов строки', сырых, 0);
