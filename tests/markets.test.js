...
ок('в промпте язык поиска привязан к языку исследования',
   /ЯЗЫК ПОИСКА И КОНТЕНТА — ЭТО ЯЗЫК ИССЛЕДОВАНИЯ/.test(SRC), 'нет');
ок('и сказано, кто проверяет арабский разбор',
   /правильность такого разбора проверяет владелец сам/.test(SRC), 'нет');
