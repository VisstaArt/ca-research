...
var д={источники_радара:[],стратегия:[],каналы:[],залетает:[],паттерны:[],бенчмарки:[],каналы_заказчика:[],
...
['Telegram','блог на своём сайте','vc.ru'].forEach(function(п,i){
  д.стратегия.push({площадка:п,приоритет:i+1,почему_туда:'там сидят владельцы магазинов',
...
ok('стратегия собрана', /renderPlan\(/.test(blockScriptsM3.join(' ')), true);
ok('сводная таблица собрана', /renderPlanTable\(/.test(blockScriptsM3.join(' ')), true);
