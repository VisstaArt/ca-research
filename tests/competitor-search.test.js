...
// Потолок держим в разумных рамках, но глубину не режем: владелица заводит
// несколько ключей поиска, и переключение между ними важнее экономии.
ok('поисковых вызовов на модуль не больше 32', вызовы.reduce(function(a,b){return a+b;},0)<=32, true);
