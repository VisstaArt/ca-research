...
ок('у физлица правило включается',
   /НЕ СОВЕТУЙ/.test(правилоБезРеквизитов({funnel_needed:'да',legal_form:'физлицо'})), 'молчит');
ок('вторая часть есть, а форма не указана — тоже включается',
   /НЕ СОВЕТУЙ/.test(правилоБезРеквизитов({funnel_needed:'да',legal_form:''})), 'молчит');
ок('вместо форм предлагается мессенджер',
   /мессенджер/.test(правилоБезРеквизитов({funnel_needed:'да',legal_form:'физлицо'})), 'нет замены');
