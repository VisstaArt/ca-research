...
(function (root) {
  ...
  function buildAgentPackage(brief, lang, results, report, opts) {
    ...
    const researchSources = pickTable(globalModules, 'M1_2', 'BLOCK 04_0');
    ...
    for (const nicheName of Object.keys(byNiche)) {
      ...
      research_by_niche[nicheName] = {
        ...
        ALTERNATIVES: pickTable(modulesForNiche, 'M3', 'BLOCK 07C'),
          ...
          VISUAL_STRATEGY: [...pickTable(modulesForNiche, 'M6', 'BLOCK 19'),
                            ...pickTable(modulesForNiche, 'M6', 'BLOCK 19A')],
